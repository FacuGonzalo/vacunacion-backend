<title>vacuNacion | Administrador</title>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-blue-200 border-b border-gray-200">
                    BIENVENIDO <b>{{Auth::user()->name}}</b>, usted ingreso con el rol de <b>Administrador</b>.
                    <br>
                    Aqui podra cargar, listar, editar y eliminar CENTROS DE VACUNACION
                    <br>
                    <br>
                    <hr />
                    <br>
